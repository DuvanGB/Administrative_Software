...
public class Clientes extends javax.swing.JFrame {
    ...
    public void Buscar(){//filtro que permite buscar un parametro ingresado en toda la tabla
        ...
        tablacli.setRowSorter(modeloOrdenado);//se reemplaza la tabla filtrada con la tabla original
    ...
    private void initComponents() {
        ...
        tablacli.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        tablacli.setSelectionBackground(new java.awt.Color(255, 153, 0));
    ...
    private void b1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b1ActionPerformed
        ...
        } else//si se selecciono una fila 
        {
            ...
            facturacion.t1.setText(String.valueOf(tablacli.getValueAt(i,0)));
            facturacion.t4.setText(String.valueOf(tablacli.getValueAt(i,1)));
            facturacion.t5.setText(String.valueOf(tablacli.getValueAt(i,2)));
            facturacion.t6.setText(String.valueOf(tablacli.getValueAt(i,3)));  
        }
    ...
    public static javax.swing.JTable tablacli;
